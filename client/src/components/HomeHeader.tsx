...
export const Header = ({setProducts, products}: {setProducts: (products: any[]) => void, products: any[]}) => {
  ...
  return (
    <header className="flex justify-center items-center w-full mt-4 text-white gap-5">
      <button
